...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validar data de nascimento (mínimo 16 anos)
...
// Determinar ícone e cor baseado no tipo de usuário
switch ($usuario['tipo']) {
    case 'coordenador':
...
<head>
    ...
    <style>
        /* Apenas as regras que usam cores dinâmicas ficam aqui */
        .profile-icon {
            color: <?php echo $cor; ?>;
        }
...
<body>
    <div class="form-container">
        ...
        <form method="POST" onsubmit="return validarFormulario()">
            ...
            <a href="perfil.php" class="btn btn-secondary btn-block mt-2">Cancelar</a>
        </form>
    </div>
